function ProductDesc() {
  return (
    ...
    <div className="pb-4">
      <h2 className="text-3xl font-bold">Les Privat 1 Guru 1 Siswa</h2>
      <p className="text-2xl font-semibold text-[#2A9CD8]">Rp 40.000 - Rp 65.000</p>
      <span className="text-yellow-400">★★★★★</span> <span className="text-gray-700">(99+ siswa telah mendaftar)</span>
